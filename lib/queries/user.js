...
/**
 * Returns ['lesson:uuid-1', 'lesson:uuid-2', ...] for standalone lessons
 * the current user has completed. Course lessons are intentionally
 * excluded — those are fetched per-course by fetchCompletedLessonKeys().
 */
